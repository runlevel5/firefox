...
//
// i64x2.extmul_{low,high}_i32x4_{s,u} when the register allocator picks
// dest == rhs: a lowering that writes the low-lane product to dest before it
// has fully read rhs computes the high lane from garbage. The loops below
// force the aliasing; on PPC64 (where this was reduced from argon2.wasm) the
// high i64 lane came back 0 on POWER9 Ion and garbage on POWER8 Ion.
